...
const Home = () => {
    ...
    const handleLogin = () => {
        window.location = `${spotify_authorize_endpoint}?client_id=${client_id}&scope=${scopes_url_param}&response_type=token&show_dialog=true&redirect_uri='${redirect_utl_after_login}'`
    }
